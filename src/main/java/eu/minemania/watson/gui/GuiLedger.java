...
public class GuiLedger extends GuiBase
{
    ...
    public void initGui()
    {
        ...
        if (ledgerInfo.getLedgerMode() != LedgerMode.INSPECT)
        {
            ...
            this.textFieldRange = new GuiTextFieldInteger(x + offset + 20, y + 2, width, 14, this.font);
            this.textFieldRange.setValueWrapper(String.valueOf(ledgerInfo.getRange()));
            ...
            this.textFieldSource = new GuiTextFieldGeneric(textFieldRange.getX() + offset + 20, y + 2, width, 14, this.font);
            this.textFieldSource.setValueWrapper(ledgerInfo.getSources());
            ...
            this.textFieldTimeBefore = new GuiTextFieldGeneric(x + offset + 20, y + 2, width, 14, this.font);
            this.textFieldTimeBefore.setValueWrapper(ledgerInfo.getTimeBefore());
            ...
            this.textFieldTimeAfter = new GuiTextFieldGeneric(textFieldTimeBefore.getX() + offset + 20, y + 2, width, 14, this.font);
            this.textFieldTimeAfter.setValueWrapper(ledgerInfo.getTimeAfter());
        ...
        if (ledgerInfo.getLedgerMode() == LedgerMode.INSPECT)
        {
            ...
            this.textFieldX = new GuiTextFieldInteger(x + offset + 20, y + 2, width, 14, this.font);
            this.textFieldX.setValueWrapper(String.valueOf(ledgerInfo.getX()));
            ...
            this.textFieldY = new GuiTextFieldInteger(textFieldX.getX() + offset + 20, y + 2, width, 14, this.font);
            this.textFieldY.setValueWrapper(String.valueOf(ledgerInfo.getY()));
            ...
            this.textFieldZ = new GuiTextFieldInteger(textFieldY.getX() + offset + 20, y + 2, width, 14, this.font);
            this.textFieldZ.setValueWrapper(String.valueOf(ledgerInfo.getZ()));
        ...
        if (ledgerInfo.getLedgerMode() == LedgerMode.INSPECT || ledgerInfo.getLedgerMode() == LedgerMode.SEARCH)
        {
            ...
            this.textFieldPages = new GuiTextFieldInteger(x + offset + 20, y + 2, width, 14, this.font);
            this.textFieldPages.setValueWrapper(String.valueOf(ledgerInfo.getPages()));
    ...
    private ArrayList<String> getDimensions(String dimensionText)
    {
        ...
        Set<ResourceKey<Level>> dimensions = networkHandler.levels();
        for (ResourceKey<Level> dimension : dimensions)
        {
            String dimensionString = dimension.identifier().toString();
            ...
            {
                currentDimensions.add(dimension.identifier().toString());
            }
        }
    ...
    public static class SourceTextFieldListener implements ITextFieldListener<GuiTextFieldGeneric>
    {
        ...
        public boolean onTextChange(GuiTextFieldGeneric textField)
        {
            try
            {
                parent.ledgerInfo.setSources(textField.getValueWrapper());
            }
            catch (Exception e)
            {
    ...
    public static class TimeBeforeTextFieldListener implements ITextFieldListener<GuiTextFieldGeneric>
    {
        ...
        public boolean onTextChange(GuiTextFieldGeneric textField)
        {
            try
            {
                parent.ledgerInfo.setTimeBefore(textField.getValueWrapper());
            }
            catch (Exception e)
            {
    ...
    public static class TimeAfterTextFieldListener implements ITextFieldListener<GuiTextFieldGeneric>
    {
        ...
        public boolean onTextChange(GuiTextFieldGeneric textField)
        {
            try
            {
                parent.ledgerInfo.setTimeAfter(textField.getValueWrapper());
            }
            catch (Exception e)
            {
    ...
    public static class RangeTextFieldListener implements ITextFieldListener<GuiTextFieldInteger>
    {
        ...
        public boolean onTextChange(GuiTextFieldInteger textField)
        {
            try
            {
                parent.ledgerInfo.setRange(Integer.parseInt(textField.getValueWrapper()));
            }
    ...
    public static class XTextFieldListener implements ITextFieldListener<GuiTextFieldInteger>
    {
        ...
        public boolean onTextChange(GuiTextFieldInteger textField)
        {
            try
            {
                parent.ledgerInfo.setX(Integer.parseInt(textField.getValueWrapper()));
            }
            catch (Exception ignored)
            {}
    ...
    public static class YTextFieldListener implements ITextFieldListener<GuiTextFieldInteger>
    {
        ...
        public boolean onTextChange(GuiTextFieldInteger textField)
        {
            try
            {
                parent.ledgerInfo.setY(Integer.parseInt(textField.getValueWrapper()));
            }
            catch (Exception ignored)
            {}
    ...
    public static class ZTextFieldListener implements ITextFieldListener<GuiTextFieldInteger>
    {
        ...
        public boolean onTextChange(GuiTextFieldInteger textField)
        {
            try
            {
                parent.ledgerInfo.setZ(Integer.parseInt(textField.getValueWrapper()));
            }
            catch (Exception ignored)
            {}
    ...
    public static class PagesTextFieldListener implements ITextFieldListener<GuiTextFieldInteger>
    {
        ...
        public boolean onTextChange(GuiTextFieldInteger textField)
        {
            try
            {
                parent.ledgerInfo.setPages(Integer.parseInt(textField.getValueWrapper()));
            }
            catch (Exception ignored)
            {}
    ...
    public static class ButtonListener implements IButtonActionListener
    {
        ...
        public void actionPerformedWithButton(ButtonBase button, int mouseButton)
        {
            ...
            if (this.type == ButtonType.SUBMIT)
            {
                ...
                {
                    case INSPECT -> DataManager.getInspectHandler().encodePayload(BlockPos.containing(x, y, z), pages);
