        ...
        implements ICompletionListener, ISelectionListener<GuiBlockeditData.YHeightFilter>
{
    ...
    private void createTimeInput(int x, int y, int width)
    {
        ...
        this.textFieldTimeAgo = new GuiTextFieldGeneric(x + offset + 20, y + 2, width, 14, this.font);
        this.textFieldTimeAgo.setValueWrapper("0-0 0:0:0");
        this.addTextField(this.textFieldTimeAgo, new TimeAgoTextFieldListener(this));

        this.textFieldYHeight = new GuiTextFieldGeneric(this.textFieldTimeAgo.getX() + this.textFieldTimeAgo.getWidth() + 20, y + 2, width, 14, this.font);
        this.textFieldYHeight.setValueWrapper("0");
    ...
    private void reloadInput()
    {
        ...
        {
            this.textFieldTimeAgo.setValueWrapper(TimeStamp.formatMonthDayTime(this.getTime()));
        }
        if (this.textFieldYHeight != null)
        {
            this.textFieldYHeight.setValueWrapper(String.valueOf(this.getYHeight()));
        }
    ...
    public static class TimeAgoTextFieldListener implements ITextFieldListener<GuiTextFieldGeneric>
    {
        ...
        public boolean onTextChange(GuiTextFieldGeneric textField)
        {
            try
            {
                String textValue = textField.getValueWrapper();
    ...
    public static class YHeightTextFieldListener implements ITextFieldListener<GuiTextFieldGeneric>
    {
        ...
        public boolean onTextChange(GuiTextFieldGeneric textField)
        {
            try
            {
                String yHeightString = textField.getValueWrapper();
